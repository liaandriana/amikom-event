...
@section('page_subtitle', 'Perbarui data pengurus.')
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea
                    name="description"
                    rows="4"
                    class="w-full rounded-2xl border border-slate-300 px-5 py-3 focus:ring-2 focus:ring-indigo-500 focus:outline-none">{{ old('description',$pengurus->description) }}</textarea>
